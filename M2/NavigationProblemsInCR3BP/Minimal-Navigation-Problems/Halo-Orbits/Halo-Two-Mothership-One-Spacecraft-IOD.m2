...
orbitContraintTuples = {{A,CPolynomialCoeffMatrix,heightCPolynomialCoeffMatrix,c}}
...
-- Build minimal problem
needs (minimalProblemDirectory | orbitType | "-Orbits/" | orbitType | "-Two-Mothership-One-Spacecraft-IOD.m2")
findDegree(orbitContraintTuples,distanceConstraintTuples,Y,{jacobiConstantDegree,modelDegree},OrbitScenario => orbitType) -- found 84 complex solutions
